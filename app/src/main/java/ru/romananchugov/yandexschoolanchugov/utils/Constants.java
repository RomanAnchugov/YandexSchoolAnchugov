...
public class Constants {
    ...
    public static final String SLIDER_IMAGES_POSITION_KEY = "imagesPosition";

    public static final String SLIDER_FRAGMENT_TAG = "Slider";
    public static final String GALLERY_FRAGMENT_TAG = "Gallery";
    public static final String ADD_PHOTO_DIALOG_TAG = "Add new photo";
    ...
    public static final String STORAGE_INFO_FRAGMENT_TAG = "Storage info";
    public static final String CLEAR_TRASH_DIALOG_TAG = "Clear trash";
}
